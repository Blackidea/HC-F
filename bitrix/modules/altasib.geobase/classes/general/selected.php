...
Class CAltasibGeoBaseSelected extends CAltasibGeoBaseAllSelected
{
	...
	function GetArReplace()
	{
		$arRepl = array();
		for($i=0, $strm = 'ALTASIB_R_'; $i<11; $i++)
		{
	...
	function GetArReplaceLocations()
	{
		$arRpl = array();
	...
	function GetUFValue($valueID, $fieldID = false)
	{
		...
		if($fieldID)
			...
			return $USER_FIELD_MANAGER->GetUserFieldValue(self::UF_OBJECT_ENTITY_ID, self::UF_FIELD_URL, $valueID, false);
	}
}
